...
async function run() {
    ...
    try {
        ...
        const launchOk = launchRes && launchRes.result !== undefined ? launchRes.result : launchRes;
        assert.strictEqual(launchOk, "OK");
        ...
        const stopOk = stopRes && stopRes.result !== undefined ? stopRes.result : stopRes;
        assert.strictEqual(stopOk, "OK");
